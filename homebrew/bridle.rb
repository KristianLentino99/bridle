...
class Bridle < Formula
  ...
  url "https://github.com/KristianLentino99/bridle/releases/download/v0.1.0/bridle-v0.1.0-aarch64-apple-darwin.tar.gz"
  ...
  on_macos do
    ...
    if Hardware::CPU.intel?
      url "https://github.com/KristianLentino99/bridle/releases/download/v0.1.0/bridle-v0.1.0-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/KristianLentino99/bridle/releases/download/v0.1.0/bridle-v0.1.0-x86_64-unknown-linux-gnu.tar.gz"
